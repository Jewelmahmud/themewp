...
var swiper_banner = new Swiper(".slide-banner", {
        ...
        pagination: { el: ".s-banner .swiper-pagination",clickable: true, },
    }),
    ...
    swiper_slide = new Swiper(".slide-images", {
        ...
        breakpoints: { 700: { slidesPerView: 3, spaceBetween: 9 }, 300: { slidesPerView: 1.7, spaceBetween: 3 } },
    }),
...
inputForm.forEach(function (e) {
    ...
    (popup = new mapboxgl.Popup({ closeOnClick: !1, closeButton: !1 })
        ...
        .setHTML(
            '<a href="https://goo.gl/maps/f2Jvi2t5ksHRSLfG8" target="_blank" class="popup show"><div class="text"><strong>Adres</strong><p>Schorsweg 13e <br>8171 ME Vaassen</p></div></a>'
        )
        .addTo(map)));
