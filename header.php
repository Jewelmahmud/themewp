      ...
      <?php 
        ...
        ?>
          ...
          <div class="mobileLogin">
            ...
            <ul>
              <?php $loginlinksmobile = $otheroption['login_icons_and_links'] ?>
              <?php if($loginlinksmobile){foreach($loginlinksmobile as $linkmobile){?>
              <li>
                <a href="<?php echo $linkmobile['login_url']; ?>" target="_blank">
                <img
                      src="<?php echo $linkmobile['icon']['url']; ?>"
                      alt="<?php echo $linkmobile['icon']['alt']; ?>"
                    />
                </a>
              </li>
              <?php }} ?>
...
<?php 
  ...
  if(is_page_template( 'templates/about.php' ) || is_page_template( 'templates/contact.php' ) || is_page_template( 'templates/diensten.php' ) || is_page_template( 'templates/faq.php' ) || is_page_template( 'templates/news.php' ) || is_page_template( 'templates/team.php' ) || is_page_template( 'templates/whitepapers.php' ) || is_page_template( 'default' ) || is_singular('diensten') || is_search()){ 
      if(!is_single() ){
